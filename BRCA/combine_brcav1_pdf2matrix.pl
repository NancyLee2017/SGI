...
#	print "open $out success!\n";
	while(<FILE>){
		...
		my $consequence=$t[9];
		my $ClinSig=$t[10];
		my $k=join "\t",$gene,$locus,$exon,$genotype,$ref,$variant,$AAchange,$type,$consequence,$ClinSig;
#		print "$k\n";
		my $o=" ";
...
print OT "Gene\tLocus\tExon\tGenotype\tRef\tVariant\tAA_change\tType\tConsequence\tClin_Sig\t";
